  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white relative overflow-hidden p-4 sm:p-8 font-sans">
      ...
      <div className="absolute top-6 left-6 z-20">
        <Button onClick={() => navigate('/')} className="bg-gray-900/60 backdrop-blur-sm border border-purple-400/30 hover:bg-gray-800/60 text-purple-200"><ArrowLeft className="w-5 h-5 mr-2" />Back to Home</Button>
      </div>
